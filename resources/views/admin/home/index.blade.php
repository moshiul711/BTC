        ...
        <div class="col-lg-6 col-sm-12 col-md-6 col-xl-3">
            <div class="card overflow-hidden">
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                            <h3 class="mb-2 fw-semibold">{{ number_format($order['visitor']) }}</h3>
                            <p class="text-muted fs-13 mb-0">Product Visitors</p>
                        </div>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                            ...
                            <p class="text-muted fs-13 mb-0">Complete Orders</p>
            ...
            <div class="card product-sales-main">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="basic-datatable" class="table text-nowrap mb-0 table-bordered">
