                ...
                <div class="card-body">
                    ...
                    <form class="login100-form validate-form" action="{{ route('update-password',$customer->id) }}" method="post">
                        ...
                        <div class="wrap-input100 validate-input" data-bs-validate = "Valid email is required: ex@abc.xyz">
                            <input class="input100" type="text" name="new_password" placeholder="Enter New Password" required>
                        ...
                        <div class="wrap-input100 validate-input" data-bs-validate = "Valid email is required: ex@abc.xyz">
                            <input class="input100" type="text" name="confirm_password" placeholder="Enter Confirm Password" required>
                            <span class="focus-input100"></span>
                            <span class="symbol-input100">
                                <i class="zmdi zmdi-email" aria-hidden="true"></i>
                            </span>
