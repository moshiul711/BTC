                                        ...
                                        <div class="carousel slide h-100" data-bs-interval="t" id="thumbcarousel">
                                            <div class="carousel-inner h-100">
                                                <ul class="carousel-item active d-flex h-100">
                                                    <li class="thumb my-2" data-bs-slide-to="0" data-bs-target="#Slider"><img alt="img" src="{{ asset('/') }}website/assets/images/pngs/6.png"></li>
                                                    <li class="thumb my-2" data-bs-slide-to="1" data-bs-target="#Slider"><img alt="img" src="{{ asset('/') }}website/assets/images/pngs/2.png"></li>
                                                    <li class="thumb my-2 active" data-bs-slide-to="2" data-bs-target="#Slider"><img alt="img" src="{{ asset('/') }}website/assets/images/pngs/3.png"></li>
                                                    <li class="thumb my-2" data-bs-slide-to="3" data-bs-target="#Slider"><img alt="img" src="{{ asset('/') }}website/assets/images/pngs/4.png"></li>
                                                    <li class="thumb my-2" data-bs-slide-to="4" data-bs-target="#Slider"><img alt="img" src="{{ asset('/') }}website/assets/images/pngs/9.png"></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="carousel slide h-100" data-bs-ride="false" id="Slider">
                                            <div class="carousel-inner h-100">
                                                <div class="carousel-item">
                                                    <img alt="img" class="img-fluid w-100 d-block" src="{{ asset('/') }}website/assets/images/pngs/6.png">
                                                </div>
                                                <div class="carousel-item">
                                                    <img alt="img" class="img-fluid w-100 d-block" src="{{ asset('/') }}website/assets/images/pngs/2.png">
                                                </div>
                                                <div class="carousel-item active">
                                                    <img alt="img" class="img-fluid w-100 d-block" src="{{ asset('/') }}website/assets/images/pngs/3.png">
                                                </div>
                                                <div class="carousel-item">
                                                    <img alt="img" class="img-fluid w-100 d-block" src="{{ asset('/') }}website/assets/images/pngs/4.png">
                                                </div>
                                                <div class="carousel-item">
                                                    <img alt="img" class="img-fluid w-100 d-block" src="{{ asset('/') }}website/assets/images/pngs/9.png">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <ul class="comment-section-main">
                                                <li>
                                                    <div class="media mb-5 cnsl">
                                                        <div class=" me-3">
                                                            <a href="#"><img alt="64x64" class="media-object rounded-circle thumb-sm" src="{{ asset('/') }}website/assets/images/users/5.jpg"></a>
                                                        </div>
                                                ...
                                                <li class="mb-0">
                                                    <div class="media mb-0">
                                                        <div class=" me-3">
                                                            <a href="#"><img alt="64x64" class="media-object rounded-circle thumb-sm" src="{{ asset('/') }}website/assets/images/users/15.jpg"></a>
                                                        </div>
                                                        <div class="media-body">
                                                            <div class="name-time-container d-flex">
                    ...
                    <div class="card item-card">
                        <div class="product-grid6 card-body">
                            <div class="product-image6">
                                <a href="{{ route('product-details') }}" class="img-container">
                                    <img class="img-fluid" src="{{ asset('/') }}website/assets/images/pngs/6.png" alt="img">
                                </a>
                                <div class="icon-container">
                                    <ul class="icons">
                                        <li>
                                            <a href="{{ route('product-details') }}" data-tip="Quick View">
                                        ...
                                        <li>
                                            <a href="{{ route('cart.show') }}" data-tip="Add to Cart">
                            ...
                            <div class="product-content w-100 p-3">
                                <div class="mb-2">
                                    <h4 class="mb-1 text-normal"> <a href="{{ route('product-details') }}">Wood Photo Frame - Size(M)</a> </h4>
